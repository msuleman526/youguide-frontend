    ...
    <div>
      ...
      <Card>
        ...
        <ol>
          ...
          <li>System generates Stripe payment with unique transaction_id</li>
      ...
      init();
        ...
        <Card style={{ marginBottom: '15px', backgroundColor: '#fff7e6', border: '1px solid #ffd591' }}>
          ...
          <ul style={{ marginTop: '10px', marginBottom: '10px', lineHeight: '1.8' }}>
            ...
            <li><Text code>POST /api/travel-guides/pdf/secure/checkout</Text> - Create Stripe checkout payment</li>
